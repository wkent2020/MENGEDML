...
direct = 'individual_developers/jackson/'
file = "120.tif"
...
def getContours(numMeans = 3):
	binaryImage, image, contours = segmentedThresholding(img, 1, 1, numMeans, filter = None, pixelThresh = False, save = False)
